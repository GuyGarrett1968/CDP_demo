...
class WebCDP(object):
    ...
    def index(self):
        ...
        <html>
        <title>Clinical Data Platform - Login</title>
        <meta charset="UTF-8">
        ...
        <body class="w3-light-grey" style="text-align:center">
            <p align="center">
               <img src="/static/CDP_splash.jpg" width="500" height="500" border="0" alt="Login">
            </p>
            <p align = "center">
                <br>
                ...
                <div style="margin:0 auto;width:100%;text-align:center">
                     <form action ="/login" method = GET>
                        <table style="margin:0 auto;width:15%;text-align:right">
    ...
    def configuration(self):
        ...
        html_code += topContainer_Layout()
        html_code += sidebar_layout(self.role, self.username)
        html_code += configuration_layout()
        html_code += footer_layout()
        return html_code
