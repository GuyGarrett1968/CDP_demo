...
def cdmTEST_layout():
    ...
    <h2> PATIENT_DIM </h2>
     ...
     <h2> Adding data:</h2>
      INSERT INTO trial_dim VALUES (3,1,"Compound 123 Twice weekly for 12 weeks at 25mg", 100, 24, 12,"25mg"),
                                                     (2,2,"987 via inhaler",100,12,52,"0.25mg")
      <br>

      INSERT INTO investigator_dim VALUES (3,"David Grant","Viking Street Copenhagen DK","CP"),
                                                            (2,"Elizabeth Newall", "watchmaker Parade Basel CH","CP")

      <br>
      INSERT INTO patient_dim VALUES (3,9003,7693,"F",170),
                                                       (4,9004,6073,"M",180)

      <br>
      INSERT INTO visit_dim VALUES (3,21220,"456 Road Lane")

      <br>
      INSERT INTO visit_fact VALUES (2,2,3,3,3,"130/75",36,200,"0.25mg","Inhaler"),
                                                      (2,2,4,4,3,"110/85",35,140,"0.25mg","Inhaler")

    <br><br>     
    <form action="/cdmtest_adddata">
