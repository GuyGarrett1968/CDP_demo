...
def sidebar_layout(role, username):
    ...
    if role == "Data Management":
        ...
        sections = '<a href="overview" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i>  Overview</a>'
        sections += '<a href="myStudies" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i>  My Studies</a>'
        sections += '<a href="designStudy" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i>  Protocol Design</a>'
        sections += '<a href="designStudy" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i>  eCRF</a>'
        sections += '<a href="configuration" class="w3-bar-item w3-button w3-padding"><i class="fa fa-wrench fa-fw"></i>  Configuration</a>'
